...
from util.prep import cut_edge, image_norm, make_onehot_label

class DataGen(object):
    def __init__(self, file_path, id_list=[1,2,3,4,5,6,7], batch_size=20, cube_size=32):
        ...
        for ids in id_list:
            ...
            print("Load training file: {}".format(subject_name))
